...
namespace ZCompileCore.Lex
{
    public class LexToken
    {
        ...
        public static LexToken EOF = new LexToken() { Kind= TokenKind.EOF };
        ...
        public LexToken(string text,TokenKind kind,int line ,int col)
        {
            Text = text;
            Kind = kind;
            Line = line;
        ...
        //{
        //    return WKind == WordKind.TypeName || WKind == WordKind.GenericClassName;    
        //}

        //public bool IsProcPart()
        //{
        //    return WKind == WordKind.ProcNamePart;
        //}

        //public bool IsVarName()
        //{
        //    return WKind == WordKind.ArgName 
        //        || WKind == WordKind.EnumElement 
        //        || WKind == WordKind.MemberName 
        //        || WKind == WordKind.VarName;
        //}
        ...
        public bool IsLiteral
        {
            get
            {
                return TokenKindHelper.IsLiteral(this.Kind);
            }
        }
