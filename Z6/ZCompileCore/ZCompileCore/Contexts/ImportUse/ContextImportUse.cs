...
namespace ZCompileCore.Contexts
{
    public class ContextImportUse
    {
        ...
        public ContextImportTypes ContextFileManager;
        private ContextUse useContext;
        ...
        public ZType[] SearchImportType(string typeName)
        {
            ...
            return ContextFileManager.SearchZTypeByClassNameOrDimItem(typeName);
        }
        ...
        public void BuildSegementer()
        {
            this.ContextFileManager.BuildZCompiling();
        }
