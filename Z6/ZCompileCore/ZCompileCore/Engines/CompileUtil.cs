        ...
        {
            {
                ...
                CustomAttributeBuilder attributeBuilder = new CustomAttributeBuilder(infoConstructor, new object[] { "ZyyLib" });
                builder.SetCustomAttribute(attributeBuilder);
            }
            {
                Type myType = typeof(AssemblyVersionAttribute);
                ConstructorInfo infoConstructor = myType.GetConstructor(new Type[] { typeof(string) });
                CustomAttributeBuilder attributeBuilder = new CustomAttributeBuilder(infoConstructor, new object[] { "0.6.0" });
                builder.SetCustomAttribute(attributeBuilder);
            }
            {
            ...
            }
            {
                ...
                ConstructorInfo infoConstructor = myType.GetConstructor(new Type[] { typeof(string) });
                CustomAttributeBuilder attributeBuilder = new CustomAttributeBuilder(infoConstructor, new object[] { "Zyy" });
                builder.SetCustomAttribute(attributeBuilder);
            }
            {
