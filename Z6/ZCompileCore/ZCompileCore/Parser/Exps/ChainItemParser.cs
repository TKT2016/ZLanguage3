...
namespace ZCompileCore.Parsers.Exps
{
    ...
    {
        private ArrayTape<object> Tape;
        private ContextExp ExpContext;
        private Stack<object> chains = new Stack<object>();
        private ChainItemFeaturer featurer;
        private bool IsAssignTo;

        public object[] ParseItems(IEnumerable<object> elements, ContextExp context, bool isAssignTo)
        {
