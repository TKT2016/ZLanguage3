...
namespace ZDev.Schema.Parses
{
    public class Token
    {
        ...
        public static Token EOF = new Token("", TokenKind.EOF,0,0,0);// { Kind= TokenKind.EOF };
        /*
        public Token()
        {
        ...
        public Token(string text,TokenKind kind,int line ,int col,int index)
        {
            Text = text;
            Kind = kind;
            Line = line;
        ...
        {
            return string.Format("({0},{1},{4}){2}:{3}", Line, Col, Kind,Text,Index);
        }
        ...
        public CodePostion Postion
        {
            ...
            {
                if(_Postion==null)
                    _Postion = new CodePostion(Line, Col,Index);
                return _Postion;
            }
        }
    }
